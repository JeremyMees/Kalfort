  ...
  <div class="max-w-max">
    <button
      ...
      :class="{
        ...
        'bg-cyan-400 ring-cyan-200 text-slate-900': color === 'secondary' && !transparent,
        'text-cyan-400 ring-cyan-200': color === 'secondary' && transparent,
        'bg-red-400 ring-red-200 text-slate-900': color === 'danger' && !transparent,
